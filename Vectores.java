/**
* Write a description of class Vectores here.
 ...
 public static double [] crear_arreglo_a()
  {
   ...
   System.out.println("------------------------------------------------"); 
   System.out.println("Guia 2 Actividad 2 Programa 3 Vectores          ") ;
   System.out.println("------------------------------------------------");    
   ...
   // validamos que el numero de elementos no sea cero
   if (numero_de_elementos >0){
       System.out.println("Crearemos arreglo de " + numero_de_elementos);
    }else{
       System.out.println("número de elementos errado ");
   }
   double [] arreglo_a;
